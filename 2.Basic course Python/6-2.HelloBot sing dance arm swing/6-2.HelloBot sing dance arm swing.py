...
servos1_min = 300  # Min pulse length out of 4096  0?
servos1_max = 500  # Max pulse length out of 4096: 180?
servos2_min = 300  # Min pulse length out of 4096  0?
servos2_max = 500  # Max pulse length out of 4096: 180?
...
while True:
    ...
    left(4095)
    run(0)
    pwm.set_pwm(3, 0, servos1_min)
    pwm.set_pwm(4, 0, servos2_max)
    sleep(1000)
    pwm.set_pwm(3, 0, servos1_max)
    pwm.set_pwm(4, 0, servos2_min)
    sleep(1000)
